/**
 * Classe che contiene la cache temporanea dei dati presenti all'interno del sistema, viene aggiornata ogni volta che qualche utente si interfaccia con
 * il database per effetuare operazioni di insert o update. Tale classe è inevitabilmente un singleton
