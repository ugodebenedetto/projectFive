 ...
 * Studente
 * @author ClaudioAmato
 * Questa classe rappresenta uno Studente che è una specializzazione di Utente
 * @version 0.1
 */
public class Studente extends Utente{
	 ...
	 * @param tipoLaurea
	 */
	public Studente(String email, String codiceFiscale, String nome, String cognome, String luogoNascita,
			String dataNascita, String password, String matricola, String tipoLaurea) {
	...
	public boolean equals(Object obj) {
		...
		return (matricola.equals(other.matricola) && 
				tipoLaurea.equals(other.tipoLaurea));
	}
