 ...
 * Direttore
 * @author ClaudioAmato
 * Questa classe rappresenta un Direttore che è una specializzazione di Utente
 * @version 0.1
 */
public class Didattica extends Utente{
	 ...
	 * @param direttore
	 */
	public Didattica(String email, String codiceFiscale, String nome, String cognome, String luogoNascita,
			String dataNascita, String password, boolean direttore) {
