		...
		<div class="row">
			<div class="col-md-12">
				<div class="title-section">
					...
					<div class="sub-title" style="color: #ffbf43">Team Project:
						Five</div>
			...
			<div class="about-us style2 wrap-box pdleft">
				<div class="title-section color-title">
					<h1 class="title" style="color: #ffbf43; text-align: left;">
						ABOUT <span>US</span>
					</h1>
				</div>

				<div class="text-about-us">
					<p>Il nostro team &egrave; stato incaricato di progettare e
						sviluppare un progetto volto a migliorare la raccolta, la
						condivisione e la gestione delle informazioni relative alle
						diverse opportunit&agrave; di tirocini per gli studenti e a
						monitorare tutto il percorso burocratico e formativo del tirocinio
						del singolo studente.</p>
					<p>Quindi il sistema che vogliamo offrire ha come scopo quello
						di creare per la prima volta una sezione dedicata al processo dei
						Tirocini. Ci proponiamo di fornire uno strumento per supportare e
						promuovere le attivit&agrave; di tirocinio, assicurando che tutti
						gli stakeholder coinvolti interagiscono in modo semplice ed
						efficiente, riducendo il personale necessario e allo stesso tempo
						evitare che gli studenti ritardino i propri tempi di laurea.</p>
				</div>
