	...
	<div class="title-section color-title">
		...
		<div class="container">
			<div style="text-align: center; margin-left: 10%;" class="col-md-12">
				...
				<form action="./ModificaAnnuncio" method="post"
					enctype="multipart/form-data" id="modulo">
					...
					<table>
						<tr>
							...
							<td>Titolo</td>
							<td><label> <input name="nome" type="text" id="nome"
									size="100%" required />
							</label></td>
						</tr>
						...
						<tr>
							<td>Annuncio</td>
							<td><textarea name="body" cols="30" rows="5" id="body"
									required></textarea></td>
						</tr>
						<!-- FILE -->
						<td>Allega File</td>
						<td>
							<!-- FILE --> <input type="file" name="file1" id="inputFile"
					...
					<div class="wrap-btn" style="margin-top: 10%;">
						<input style="padding: 0px 50px 0px 50px;"
							class="flat-btn bg-color style3 " type="submit" name="submit"
							id="submit" value="Invia" />&nbsp;

						</dov>
						<div class="wrap-btn" style="margin-top: 10%">
							<input style="padding: 0px 50px 0px 50px;"
								class="flat-btn bg-color style3 " type="reset" name="cancella"
								id="cancella" value="Cancella" />
						</div>
				</form>
			</div>
		</div>
