...
<body>
			...
			<div class="col-md-6">
				<div class="info-error wrap-box pdtop65">
					<div class="title-section color-title left">
						<h1 class="title">
							<span class="color-orange">OPS!</span><br>Siamo spiacenti
							l'operazione non è avvenuta con successo!
						</h1>
						<div class="sub-title">Riprova più tardi!</div>
					</div>
					<div class="wrap-btn">
						<a class="flat-btn bg-color style3" href="home_didattica.jsp"">Vai
							Alla HOMEPAGE</a>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="..${pageContext.request.contextPath}ype="
		text/javascript" src="../bootstrap/javascript/main.js"></script>
	<script type="text/javascript"
