...
<body>
	...
	<div class="container">
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="wrap-btn">
									<a class="flat-btn" style="padding: 10px 20px"
										href="${pageContext.request.contextPath}/UsersFiles/files/moduli/<%=f.getName()%>"
										target="about_blank">Scarica</a>
								</div>
							</td>
		...
		<div style="text-align: center;">
			<form action="./GestioneModuli" method="post"
				...
				<div style="display: inline;">
					...
					<!-- UPLOAD -->
					<input type="submit" name="dati" value="Invia" id="submitUpload"
						style="display: none"> <label for="submitUpload"
						class="flat-btn bg-color" style="margin: 8% 5%">UPLOAD</label>
				</div>
			</form>
		</div>
		<!-- IMPLEMENTAZIONE -->
