			...
			<div class="col-md-9 col-sm-8 wrap-reponsive">
				<div class="wrap-course-details">
					...
					<div class="course-text">
						<h3 class="course-title-text">DESCRIZIONE TIROCINIO</h3>
						<p><%=t.getDescrizione()%></p>
					</div>
					<div class="course-testimonials"></div>
					<div class="course-text content2">
						<h3 class="course-title-text">OBIETTIVI</h3>
						<p><%=t.getObiettivi()%></p>
					</div>
					<div class="course-text content2">
						<h3 class="course-title-text">DOVE SI SVOLGE?</h3>
						<p><%=t.getSede()%></p>
					</div>
				</div>
				>
