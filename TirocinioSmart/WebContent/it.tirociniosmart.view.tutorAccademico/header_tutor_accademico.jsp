			...
			<div class="col-md-12">
				...
				<div class="myHeaderClass">
					...
					<div class="wrap-nav">
						...
						<ul class="menu">
							<li><a href="home_tutor_accademico.jsp" title="">HOME</a></li>
							<li><a href="./VisualizzaListaTirocini">I MIEI TIROCINI</a>
								<ul class="submenu">
									<li><a href="aggiungi_tirocinio.jsp">Aggiungi
											Tirocinio</a></li>
									<li class="menu"><a href="./VisualizzaRichiestaTirocinio">Richieste
											Tirocinio</a></li>
								</ul></li>
							<li><a href="./VisualizzaInfoTirocini" title="">I MIEI
									TIROCINANTI</a></li>
							<li><a href="account_tutor_accademico.jsp" title="">IL
									MIO PROFILO</a></li>
						</ul>
						</nav>
