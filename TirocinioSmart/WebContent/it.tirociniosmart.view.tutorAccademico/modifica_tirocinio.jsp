					...
					<div class="info-register">
						...
						<p class="wrap-input-name">
							<label for="nam">Nome </label><input type="text" id="nam" name="nome" value="" maxlength="40" min="3"
								required="required" placeholder="Nome Tirocinio">
						</p>
						<br>
						<p class="wrap-input-name">
							<label for="obi">Obiettivi </label> <input type="text" id="obi" name="Obiettivi" value=""
								required="required" placeholder="Prendere obiettivi del tirocinio" maxlength="2000" min="5">
						</p>
						<p class="wrap-input-name">
							<label for="des">Descrizione </label> <input type="text" id="des" name="Descrizione" value=""
								required="required" placeholder="Prendere Descrizione del Tirocinio " maxlength="2000" min="5">
						</p>
						<p class="wrap-input-name">
							<label for="num">Numero Posti</label> <input type="text" id="num" name="Numero Posti" value="" required="required" placeholder="X">
							</p>
						</div>
