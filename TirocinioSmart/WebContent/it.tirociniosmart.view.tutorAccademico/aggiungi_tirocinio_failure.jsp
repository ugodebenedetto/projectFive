                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="icon-error">
                            <img src="../images/stop.jpeg" alt="image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-error wrap-box pdtop65">
                            <div class="title-section color-title left">
                                <h1 class="title"><span class="color-orange">OPPS!</span>QUESTO TIROCINIO NON PUO' ESSERE AGGIUNTO!</h1> 
                                <div class="sub-title">
                                    Controlla di non aver inserito in modo errato qualche campo<br>o se il tirocinio già esiste!
                                </div>
                            </div>
                            <div class="wrap-btn">
